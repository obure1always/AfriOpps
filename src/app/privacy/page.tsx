          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 text-gray-600 mb-4">
                ...
                <li>Send you relevant opportunities</li>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 text-gray-600 mb-4">
                <li>Employers and organizations posting opportunities</li>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-600">
                If you have any questions about this Privacy Policy, please contact us at privacy@afriopps.com
              </p>
            </section>
          </div>
        </div>
